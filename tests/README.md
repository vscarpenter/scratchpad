...
| JSON, Markdown, and encrypted import/export, image attachments, the linked folder, plus sharing and saving a shared note | `import.spec.js`, `attachments.spec.js`, `linked-folder.spec.js`, `markdown-import.spec.js`, `encrypted-backup.spec.js`, `share-export.spec.js`, `shared-copy.spec.js`, `backup-reminder.spec.js` |
